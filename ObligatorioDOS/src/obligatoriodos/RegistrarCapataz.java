...
public class RegistrarCapataz extends javax.swing.JFrame {
    ...
    public RegistrarCapataz(Sistema sistema) {
        ...
        initComponents();
        btnRegistrarCapataz.addActionListener(new ActionListener() {
            @Override
    ...
    private void btnRegistrarCapataz() {
        boolean capatazRegistrado = false;
        while (!capatazRegistrado) {
            ...
            int anioIngreso;
            try {
                anioIngreso = Integer.parseInt(anioStr);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarCapataz.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
        // </editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarCapataz(sistema).setVisible(true); // Pasar la instancia de Sistema al constructor de
                // RegistrarCapataz
            }
        });
    }
